          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="renewable-group">
                <p><b>
                  Our Vision To be a global leader in solar EPC and trading, transforming energy generation, consumption, and accessibility. We aim to empower individuals, businesses, and communities through innovative solar solutions that promote energy independence, cost savings, and environmental stewardship.
                </b></p>
                <Image
                  alt="chris-hemsworth"
                  src={hemsworth}
